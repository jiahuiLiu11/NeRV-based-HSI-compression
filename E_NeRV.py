...
class E_NeRV_Generator(nn.Module):
    def __init__(self, cfg):
        ...
        # print(self.block_dim,cfg['mlp_dim'])
        # print("************************************************************")
    ...
    def forward_impl(self, input_id):
        ...
        # print("len emb list : ",len(t_emb_list))
        # print(t_emb_list[0].shape)
        t_emb_map = torch.stack(t_emb_list, dim=1)  # [B, h*w, L]
        # print("t_emb_map : ",t_emb_map.shape)
        # print("emb before : ",xy_emb.shape)
        ...
        # print("after trans2 and toconv : ",emb.shape)
